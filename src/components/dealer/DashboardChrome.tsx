...
export function DashboardChrome({
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_12%_18%,rgba(142, 21, 49,0.12),transparent_22%),radial-gradient(circle_at_86%_10%,rgba(236,170,93,0.14),transparent_18%),var(--page-bg)] p-3 text-[var(--text-strong)] lg:p-4">
      <div className="mx-auto flex min-h-[calc(100vh-1.5rem)] max-w-[1760px] overflow-hidden rounded-[34px] border border-white/60 bg-[rgba(255,253,248,0.84)] shadow-[0_30px_100px_-60px_rgba(15,33,41,0.55)] backdrop-blur-xl lg:min-h-[calc(100vh-2rem)]">
        <aside className="hidden lg:flex lg:w-[272px] lg:flex-col">
          <div className="sticky top-0 flex min-h-full flex-col text-white" style={{ background: 'linear-gradient(180deg, #140a0c 0%, #520a18 56%, #140a0c 100%)' }}>
