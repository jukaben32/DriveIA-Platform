    ...
    >
      ...
      >
        <div className="flex min-w-0 items-center gap-3">
          <div className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[var(--brand)] text-sm font-bold text-white shadow-[0_16px_30px_-20px_rgba(142, 21, 49,0.75)]">
            {firstLetter}
          </div>
          <div className="min-w-0">
...
export function CustomersManager({
  ...
  if (!initialSelectionApplied && customerRows[0]) {
